(function () {
    window.addEventListener("load", function () {
        setTimeout(function () {
            ...
            logo[0].href = "https://localhost:44393/";
          //  logo[0].target = "_blank";

            // Section 02 - Set logo
            logo[0].children[0].alt = "TPO Web";
            logo[0].children[0].src = "/swagger-ui/resources/favicon.png";

            // Section 03 - Set 32x32 favicon
            var linkIcon32 = document.createElement('link');
            linkIcon32.type = 'image/png';
            linkIcon32.rel = 'icon';
            linkIcon32.href = '/swagger-ui/resources/favicon.png';
            ...
            linkIcon16.rel = 'icon';
            linkIcon16.href = '/swagger-ui/resources/favicon.png';
